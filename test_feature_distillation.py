"""Test feature projection distillation strategy."""
import sys
...
OUTPUT_DIR = Path("runs/distill_0.5x_feature")
STUDENT_SCALE = 0.5

print("="*80)
print("Distillation Experiment: FEATURE PROJECTION Strategy")
print("="*80)
...
distill_config = DistillationConfig(
    strategies=(DistillationStrategy.FEATURE,),  # Feature projection only
    temperature=2.0,
    alpha=0.5,
    feature_weight=1.0,
)
...
print(f"   - Strategy: FEATURE PROJECTION (match hidden representations)")
print(f"   - Feature weight: {distill_config.feature_weight}")
